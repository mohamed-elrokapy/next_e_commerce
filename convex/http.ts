...
//     console.log("Creating user with:", { email, name, clerkId: id });

//     try {
//       await ctx.runMutation(api.users.createUser, { email, name, clerkId: id });
//     } catch (err) {
//       console.log("error creating user in convex", err);
//       return new Response("error craeting user ", { status: 500 });
//     }
//   }
//   return new Response("Hello, world!,web hook processed successfully", {
//     status: 200,
//   });
// });
// http.route({
